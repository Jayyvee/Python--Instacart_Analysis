...
Project Management: Brief, documentation.
Data: Raw and cleaned datasets (excluded from GitHub due to size).
Scripts: Python notebooks and analysis code.
Analysis: Visualizations and insight summaries.
Sent to Client: Final presentation.
# Code Overview
Python and Jupyter notebooks were used for all data cleaning, exploration, and visualization.
# Key Libraries
